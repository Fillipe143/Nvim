...
if &background == "dark"
	...
	let s:yellow          = s:light_blue
	let s:blue            = s:light_yellow
...
let s:active = s:blue
if &background == "dark"
	let s:dark_active = s:light_yellow
	let s:light_active = s:light_yellow
...
call s:h("Pmenu",         {"fg": s:norm, "bg": s:light_black})
